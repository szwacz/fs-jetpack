...
var copyFileSync = function (from, to, mode) {
  ...
  fileOps.write(to, data, { mode: mode });
};
...
var sync = function (from, to, options) {
  ...
  walker = inspector.createTreeWalkerSync(from);
...
var copyFileAsync = function (from, to, mode) {
  ...
  .then(function (data) {
    return fileOps.writeAsync(to, data, { mode: mode });
  });
};
...
var checksBeforeCopying = function (from, to, opts) {
...
var async = function (from, to, options) {
  ...
  checksBeforeCopying(from, to, opts)
  .then(function () {
