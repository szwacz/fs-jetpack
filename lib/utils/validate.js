...
const isValidTypeDefinition = function (typeStr) {
...
const detectTypeDeep = function (value) {
...
const validateArray = function (argumentValue, typeToCheck) {
...
const validateArgument = function (methodName, argumentName, argumentValue, argumentMustBe) {
...
const validateOptions = function (methodName, optionsObjName, obj, allowedOptions) {
  if (obj !== undefined) {
