...
var validate = function (methodName, argumentName, argumentValue, argumentMustBe) {
...
validate.options = function (methodName, optionsObjName, obj, allowedOptions) {
  if (obj !== undefined) {
    validate(methodName, optionsObjName, obj, ['object']);
    Object.keys(obj).forEach(function (key) {
      var argName = optionsObjName + '.' + key;
      if (allowedOptions.hasOwnProperty(key)) {
        validate(methodName, argName, obj[key], allowedOptions[key]);
      } else {
