...
var inspectSync = function (path, passedOptions) {
...
var inspectAsync = function (path, passedOptions) {
  var deferred = Q.defer();
  var options = passedOptions || {};
